...
UserService.prototype.createUser = async function createUser(data) {
  ...
  try {
    ...
    let transporter = nodemailer.createTransport({
      service: 'Gmail',
      auth: {
        user: 'foodifymun@gmail.com', // generated ethereal user
        pass: 'Foodify@9876', // generated ethereal password
      },
    });
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 60px 75px 50px; background-color: white;">
      ...
      <p style="padding-bottom: 15px; font-family: Arial, sans-serif; font-size: 18px; color: #52556B; line-height: 1.5">
      The application aims to eliminate the current issue of overpriced food items available through restaurants that make students and working individuals think twice before trying out a different cuisine style. The application will provide an interface that will allow users to buy/sell homemade food items at an affordable price.


      </p>
      <p style="padding-bottom: 15px; font-family: Arial, sans-serif; font-size: 18px; color: #52556B; line-height: 1.5">
        You are now able to login to Foodify and access all our resources.</p>
      <p style="padding: 25px 0 40px;">
        <a style="padding: 20px 25px; background-color: #46A069; color: #FFFFFF; text-decoration: none; text-transform: uppercase; font-family: Arial, sans-serif; font-size: 20px;"
          href="https://foodify-nl.herokuapp.com/login" target="_blank">CLICK HERE TO LOGIN</a>
      </p>
      <p style="padding-bottom: 15px; font-family: Arial, sans-serif; font-size: 18px; color: #52556B; line-height: 1.5">
        If you have any problem and need any help then you can call us on +1 709-743-7688.
        For more information email foodifymun@gmail.com
      </p>
      <p style="padding-bottom: 0; font-family: Arial, sans-serif; font-size: 18px; color: #52556B; line-height: 1.5">
        Thank you,<br />The Team of Foodify</p>
    </div>
    <p style="padding: 50px 0 0; text-align: center; font-family: Arial, sans-serif; font-size: 12px; color: #838A9F">
      Copyright&copy; Graduate Student Union,
  ...
  try {
    ...
    let mailOptions = {
      ...
      html: `<h2> Please click on the given link to reset the password</h2>
            <p>https://https://foodify-nl.herokuapp.com/updatepassword/${resettoken}</p>
